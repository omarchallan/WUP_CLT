...
The graph is looking more symmetrical, because now we are using 16 samples at a time which gives for more chances for opinion discrepancies. And the standard deviation is decreasing as expected because we are dividing by a larger number. In this case it's the square root of 16 which equals 4.
