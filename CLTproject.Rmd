...
The graph is looking more symmetrical, because now we are using 36 samples at a time which gives for more chances for opinion discrepancies. And the standard deviation is decreasing as expected because we are dividing by a larger number. In this case it's the square root of 36. This graph, in addition to the previous ones, demonstrates the central limit theorem by showing less standard deviation as we increase the sample size.
