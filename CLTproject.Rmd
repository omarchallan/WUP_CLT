...
The previous graph show that the mean is getting closer and closer to 50 and standard deviation is decreasing which is in accordance with a CLT theory. The standard deviation was as expected, because the sample standard deviation was 41.8671520098683 and when divided by square root 9 (the sample size) it equals approximately 13.95571734, which is close to the results with is approximately 14. Overall, the graph is getting more symmetrical.
...
The graph is looking more symmetrical, because now we are using 16 samples at a time which gives for more chances for opinion discrepancies. And the standard deviation is decreasing as expected because we are dividing by a larger number. In this case it's the square root of 16 which equals 4.And it's closer to our expected value, which is 10.466788.
...
The graph is looking more symmetrical, because now we are using 25 samples at a time which gives for more chances for opinion discrepancies. And the standard deviation is decreasing as expected because we are dividing by a larger number. In this case it's the square root of 25. And it's closer to our expected value, which is 8.373430402.
...
The graph is looking more symmetrical, because now we are using 36 samples at a time which gives for more chances for opinion discrepancies. And the standard deviation is decreasing as expected because we are dividing by a larger number. In this case it's the square root of 36. And it's closer to our expected value, which is 6.977858668. This graph, in addition to the previous ones, demonstrates the central limit theorem by showing less standard deviation as we increase the sample size.
