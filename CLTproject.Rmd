...
The previous graph show that the mean is getting closer and closer to 50 and standard deviation is decreasing which is in accordance with a CLT theory. The standard deviation was as expected, because the sample standard deviation was 41.83 and when divided by square root 9 (the sample size) it equals approximately 13.93, which is close to the results with is approximately 14. Overall, the graph is getting more symmetrical.
